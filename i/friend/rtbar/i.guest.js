...
var project = {
	...
	getLiHTML: function(data){
		return '<a href="'+data.blog+'" target="_blank" title="'+data.nick+'"><img src="'+data.photo+'" width="40" height="40" data-card-action="xpt='+data.xpt+'&type=simple&pageid=50" data-card-type="isohu" data-card="true" /></a>';
	}
};
