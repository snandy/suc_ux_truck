...
BasicDialog.prototype = {
	...
	initDialog: function(){
		...
		var html = '<div class="calendar-data-apprize-win-bg"></div>';
...
UserDialog.prototype.initDialog = function(){
	...
	var html = '<div class="calendar-data-info-win-bg"></div>';
	html += '<div class="calendar-data-info-win-con">';
	html += '<span title="关闭" class="close-icon"><a href="javascript:void(0)">关闭</a></span>';
	html += '<p class="babyapp-content">aa</p>';
	html += '<h3><span class="babyapp-content-time"></span>&nbsp;&nbsp;<a class="babyapp-content-del" href="javascript:void(0)">删除</a></h3>'
	html += '</div>';
	return $container.html(html);
};
...
UserDialog.prototype.show = function(text,datetime,callback){
	this.container.find('p.babyapp-content').html(text);
	this.container.find('span.babyapp-content-time').html(datetime);
	this.container.show();
	this.adjust();
...
InputDialog.prototype.initDialog = function(){
	...
	var html = '<div class="calendar-data-input-win-bg" style="_left:0px;_top:0px;"></div>';
	...
	html += '<div class="emit-text"><span class="error-clew">已超出10个字</span><span class="babyapp-text-counter"><em>0</em>/60字</span></div>';
	html += '</div>';
	html += '</div>';
	return $container.html(html);
};
